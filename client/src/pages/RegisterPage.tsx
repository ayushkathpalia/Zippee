    ...
    <div className="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
        <form className="login100-form validate-form">
            ...
            <div className="wrap-input100  m-b-23">
                ...
                <input className="input100" type="text" value={name} onChange={(e) => setName(e.target.value)}></input>
            </div>

            <div className="wrap-input100  m-b-23">
                <span className="label-input100">Address</span>
                <input className="input100" type="text" value={address} onChange={(e) => setAddress(e.target.value)}></input>
            </div>
            <div className="container-login100-form-btn p-t-50">
                <div className="wrap-login100-form-btn">
                    <div className="login100-form-bgbtn"></div>
                    <button className="login100-form-btn" type="button" onClick={() => registerUser()}>
                        Register
                    </button>
                </div>
            </div>
